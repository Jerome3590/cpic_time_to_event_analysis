#!/usr/bin/env python3
"""
Run cohort creation for the `ed` cohort (ed_event = 1) across
...
Usage:
    python run_series_ed.py [--skip-existing] [--concurrent-workers N]
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Run ed cohort creation for all age bands and event years"
    )
